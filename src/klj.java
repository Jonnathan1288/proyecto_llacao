 ...
 * @author carlo
 */
public class klj extends javax.swing.JFrame {

    /**
     * Creates new form klj
     */
    public klj() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(klj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
